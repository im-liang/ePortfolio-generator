...
function initEPortfolio() {
    ...
    contentDataFile = "./data/final.json";
...
function initPage() {
    ...
    if (page_title.length === page_path.length) {
    ...
    for (var i = 0; i < components.length; i++) {
        switch (components[i].component_type) {
            ...
            case 'slideshow':
                ...
                image_caption = components[i].component_desiredText.split(",");
...
function loadEPortfolio(ePortfolioData) {
    ...
    for (var i = 0; i < ePortfolioData.pages.length; i++) {
        page_title.push(ePortfolioData.pages.page_title[i]);
        page_path.push(ePortfolioData.pages.page_path[i]);
    }
}
